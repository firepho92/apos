    ...
    var DetailsHeaderBase = /** @class */ (function (_super) {
        ...
        DetailsHeaderBase.prototype.render = function () {
            ...
            if (!this._dragDropHelper && columnReorderProps) {
                ...
                this._dragDropHelper = new index_1.DragDropHelper({
                    selection: {
            ...
            return (React.createElement(FocusZone_1.FocusZone, { role: "row", "aria-label": ariaLabel, className: classNames.root, componentRef: this._rootComponent, ref: this._onRootRef, onMouseMove: this._onRootMouseMove, "data-automationid": "DetailsHeader", style: { minWidth: rowWidth }, direction: FocusZone_1.FocusZoneDirection.horizontal },
                showCheckbox
                    ? [
                        ...
                        !this.props.onRenderColumnHeaderTooltip ? (ariaLabelForSelectAllCheckbox && !isCheckboxHidden ? (React.createElement("label", { key: "__checkboxLabel", id: this._id + "-checkTooltip", className: classNames.accessibleLabel }, ariaLabelForSelectAllCheckbox)) : ariaLabelForSelectionColumn && isCheckboxHidden ? (React.createElement("label", { key: "__checkboxLabel", id: this._id + "-checkTooltip", className: classNames.accessibleLabel }, ariaLabelForSelectionColumn)) : null) : null
                    ]
                    : null,
        ...
        DetailsHeaderBase.prototype._onDrop = function (item, event) {
            ...
            if (this._draggedColumnIndex >= 0 && event) {
                ...
                var isValidDrop = this._isValidCurrentDropHintIndex();
                event.stopPropagation();
                if (isValidDrop) {
        ...
        DetailsHeaderBase.prototype._renderDropHint = function (dropHintIndex) {
            ...
            return (React.createElement("div", { key: 'dropHintKey', className: classNames.dropHintStyle, id: "columnDropHint_" + dropHintIndex },
                React.createElement(Icon_1.Icon, { key: "dropHintCaretKey", "aria-hidden": true, "data-is-focusable": false, "data-sizer-index": dropHintIndex, className: classNames.dropHintCaretStyle, iconName: 'CaretDownSolid8' }),
