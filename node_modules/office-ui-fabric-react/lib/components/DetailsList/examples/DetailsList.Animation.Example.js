...
var DetailsListAnimationExample = /** @class */ (function (_super) {
    ...
    DetailsListAnimationExample.prototype.render = function () {
        ...
        return (React.createElement(Fabric, null,
            React.createElement(DetailsList, { items: items, columns: this._columns, setKey: "set", layoutMode: DetailsListLayoutMode.fixedColumns, selectionPreservedOnEmptyClick: true, ariaLabelForSelectionColumn: "Toggle selection", ariaLabelForSelectAllCheckbox: "Toggle selection for all items", onItemInvoked: this._onItemInvoked, enableUpdateAnimations: true, getCellValueKey: this._getCellValueKey })));
    };
